...
declare module "monaco-editor/esm/vs/base/browser/ui/sash/sash.js" {
    ...
    export { type IBoundarySashes, type IHorizontalSashLayoutProvider, type IHorizontalSashOptions, type ISashEvent, type ISashOptions, type IVerticalSashLayoutProvider, type IVerticalSashOptions, Orientation, OrthogonalEdge, Sash, SashState };
}